 ...
 * @version 2.18 (Liberica 20151108)
 */
final public class MonetDriver implements Driver {
	...
	private static final String DRIVERVERSIONSUFFIX =
		"Liberica 20151108 based on MCL v1.13";
	...
	static java.util.Map<String, Integer> typeMap = new java.util.HashMap<String, Integer>();
	static {
	...
	static String getSQLTypeMap(String column) {
		...
		String ret = "CASE " + column;
 		for (Entry<String, Integer> entry : typeMap.entrySet()) {
			ret += " WHEN '" + entry.getKey() + "' THEN " + entry.getValue().toString();
 		}
